  ...
  return (
    <div className="supervisao-print-report">
      ...
      <div className="print-section print-section-overview">
        ...
        >
          <p style={{ margin: 0 }}>
            ...
            &quot;Não computar&quot;
            foram excluídos das médias
            e permanecem identificados
      ...
      {technicalExplanation && (
        <div className="print-section print-section-technical">
      ...
      <div className="print-section print-section-indicators">
        ...
        <div className="print-grid-two">
          <div className="print-card print-competency-card">
            <h4>
          ...
          <div className="print-card print-indicator-card">
            <h4>
              Termômetro de
              indicadores
            </h4>
      ...
      <div className="print-section print-section-summary">
        ...
        {recomendacoes.length ? (
          <div
            className="print-recommendations"
            style={{
              display: "grid",
              gap: "16px",
              marginBottom: "40px",
          ...
          >
            {recomendacoes.map(
              (
                ...
                <div
                  className="print-recommendation-card"
                  key={
                    item.id ||
                    `recomendacao-${index}`
                  }
