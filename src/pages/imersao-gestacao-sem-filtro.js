...
export default function ImersaoGestacaoSemFiltro() {
  return (
    <>
      {/* INJEÇÃO DO CSS DIRETAMENTE NA PÁGINA */}
      <style dangerouslySetInnerHTML={{ __html: `
        /* ==========================================================================
           LANDING PAGE: GESTAÇÃO SEM FILTRO (MOBILE-FIRST PREMIUM ED.)
           ========================================================================== */
        ...
        .lp-module-title {
          ...
          margin-bottom: 20px;
          letter-spacing: 0.02em;
          border-bottom: 2px solid var(--lp-primary-border);
          padding-bottom: 8px;
        }
        ...
        .lp-box-green {
          background-color: var(--lp-green-bg);
          border: 1px solid var(--lp-green-border);
        }

        .lp-box-red {
          background-color: var(--lp-red-bg);
        ...
        .lp-price-tier:hover {
          ...
          box-shadow: 0 8px 24px rgba(138, 37, 34, 0.08);
        }
      ...
      <div className="lp-page">
        ...
        <main>
          ...
          <section className="lp-container" style={{ padding: '80px 24px' }}>
            ...
            <p style={{ marginTop: '24px' }}>Tudo isso organizado numa metodologia prática para transformar o medo em força e a ansiedade em preparo.</p>
          </section>
          ...
          <section className="lp-bg-grey">
            <div className="lp-container">
              <h2 style={{ fontSize: '2.2rem', fontWeight: '700', marginBottom: '10px' }}>Chega de romantização irreal!!!</h2>
              <h3 className="lp-text-red" style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '24px' }}>Você merece viver uma gestação sem filtro e com verdade!!</h3>
              <p>Talvez você esteja consumindo muito conteúdo na internet e se sentindo ainda mais perdida...</p>
              <p style={{ fontWeight: '700', margin: '16px 0' }}>Gestantes em Busca de Confiança.</p>
              <p>As mulheres estão cansadas de ouvir histórias traumáticas ou versões romantizadas demais. Há momentos em que a mente pede clareza... Casais querendo se reconectar antes da chegada do bebê. Mulheres buscando acolhimento e escuta ativa.</p>
              
              <p style={{ fontWeight: '700', margin: '20px 0 10px' }}>Elas procuram ESPAÇOS SEGUROS de preparação.</p>
              <p>Espaços para tirar dúvidas sem julgamentos. Falar sobre medos reais. Praticar posições, respirações e dinâmicas de casal. Apoio especializado para despertar a força que já existe em você.</p>
              
              <p style={{ marginTop: '32px' }}>E o melhor: <strong>você não está sozinha.</strong> Você constrói esse caminho ao lado de quem vai estar segurando a sua mão no grande dia.</p>
              <p style={{ fontSize: '1.1rem', fontWeight: '600', marginTop: '16px' }}>A pergunta não é "será que vou dar conta?"<br/><span className="lp-text-red">A pergunta é: "como posso me preparar para viver isso da melhor forma possível?"</span></p>
            </div>
          </section>

          {/* 5. SOBRE AS PROFISSIONAIS */}
          <section id="sobre" className="lp-container" style={{ padding: '80px 24px' }}>
            <div className="lp-split-section">
              <div>
                ...
                <div style={{ marginBottom: '24px', paddingLeft: '16px', borderLeft: '4px solid var(--lp-primary)' }}>
                  ...
                  <p style={{ fontSize: '0.95rem', color: 'var(--lp-text-muted)' }}>Dedicada a cuidar da sua saúde mental e do preparo emocional para a chegada do bebê. Erica vai te ajudar a lidar com os medos, quebrar crenças limitantes sobre a dor, acolher suas ansiedades e fortalecer o seu emocional para o parto e puerpério.</p>
                </div>

                <div style={{ marginBottom: '24px', paddingLeft: '16px', borderLeft: '4px solid var(--lp-primary)' }}>
                  <p style={{ marginBottom: '6px', fontSize: '1.15rem' }}><strong>Lizia Nascimento – Fisioterapeuta e Doula</strong></p>
                  <p style={{ fontSize: '0.95rem', color: 'var(--lp-text-muted)' }}>Especialista na preparação física do seu corpo. Lizia vai te guiar através da biomecânica do parto, técnicas de respiração, alívio não farmacológico da dor e exercícios fundamentais para a gestação e hora do nascimento.</p>
                </div>

                <p style={{ fontWeight: '600', marginTop: '24px' }}>O corpo e a mente trabalhando juntos:</p>
                <p style={{ color: 'var(--lp-text-muted)' }}>Nós percebemos que não adianta o corpo estar pronto se a mente estiver cheia de medos. Juntas, criamos a <strong>Gestação Sem Filtro</strong> para unir o melhor da psicologia e da fisioterapia em uma experiência imersiva, garantindo que você e seu bebê tenham a recepção mais amorosa e segura possível.</p>
              </div>
              <div>
                <img src="/erica-e-lizia.jpg" alt="Erica Vilar e Lizia Nascimento" className="lp-split-image" />
              </div>
            </div>
          </section>
          ...
          <section className="lp-bg-red">
            <div className="lp-container">
              <h2 style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '10px' }}>QUANDO E ONDE VAI ACONTECER</h2>
              <div className="lp-schedule">
                ...
                <div className="lp-schedule-item">
                  ...
                  <p style={{ opacity: '0.8' }}>[Local do Evento / Cidade]</p>
                </div>
                <div className="lp-schedule-item">
                  <div className="lp-schedule-icon">👥</div>
        ...
        <footer className="lp-footer">
          <div className="lp-container">
            <div className="lp-footer-grid">
              ...
              <div className="lp-footer-links">
                <h4>Contatos das Facilitadoras</h4>
                <ul>
